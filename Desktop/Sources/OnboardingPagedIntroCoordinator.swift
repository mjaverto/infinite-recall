...
final class OnboardingPagedIntroCoordinator: ObservableObject {
  ...
  private func analyzeEnrichment(
    ...
    // Infinite Recall fork: previously delegated enrichment analysis to
    // agent bridge. Bridge has been removed; fall back to a non-LLM summary.
    log("OnboardingPagedIntroCoordinator: enrichment analysis skipped — agent bridge removed in local-first build")
